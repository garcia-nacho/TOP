...
if test -f "Results/${files%.fa*}.gbk"; then mv  Results/${files%.fa*}.gbk ./${files%.fa*}_HiCap.gbk; fi
if test -f "Results/${files%.fa*}.tsv"; then mv  Results/${files%.fa*}.tsv ./${files%.fa*}_HiCap.tsv; fi
if test -f "Results/${files%.fa*}.log"; then mv  Results/${files%.fa*}.tsv ./${files%.fa*}_HiCap.log; fi
if test -f "Results/${files%.fa*}.svg"; then mv  Results/${files%.fa*}.svg ./${files%.fa*}_HiCap.svg; fi
