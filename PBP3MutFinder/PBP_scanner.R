...
for (i in 1:length(fastas)) {
  system(paste("/home/docker/anaconda3/bin/blastn -query ", fastas[i],
               " -outfmt \'6 qseqid sseqid qstart qend sstart send slen qlen length mismatch evalue\' -db  /home/docker/pbp3/pbp3db -out /home/docker/pbp3/blast_results.tsv -num_threads 10 -perc_identity 90",
               sep = ""))
